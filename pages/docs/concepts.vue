<template>
  <Layout pageTitle="Concepts — htmlc.sh" description="Understanding how htmlc works: the rendering model, expression language, scoped styles, the Engine vs Renderer API, and how it differs from client-side Vue." :siteTitle="siteTitle">
