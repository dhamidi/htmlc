<template>
  <html lang="en">
    <head>
      ...
      <title>Documentation — {{ siteTitle }}</title>
      <meta name="description" content="htmlc documentation: template syntax, directives, component system, Go API, and expression language." />
      <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
          ...
          --code-bg: #161822; --nav-height: 60px;
        }
        ...
        th { background: var(--bg2); font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--muted); }
        p { margin: 1rem 0; }
