<template>
  ...
  >
    ...
    <h3 id="new">New</h3>
    <pre v-syntax-highlight="'go'"><code>func New(opts Options) (*Engine, error)</code></pre>
...
if err != nil {
    ...
    <pre v-syntax-highlight="'go'"><code>type Options struct {
    ComponentDir string
    Reload       bool
    FS           fs.FS
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) RenderPage(w io.Writer, name string, data map[string]any) error</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>var buf bytes.Buffer
err := engine.RenderPage(&amp;buf, "HomePage", map[string]any{
    "title": "Welcome",
})</code></pre>

    <h3 id="render-fragment">RenderFragment</h3>
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) RenderFragment(w io.Writer, name string, data map[string]any) error</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) RenderPageString(name string, data map[string]any) (string, error)
func (e *Engine) RenderFragmentString(name string, data map[string]any) (string, error)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) RenderPageContext(ctx context.Context, w io.Writer, name string, data map[string]any) error
func (e *Engine) RenderFragmentContext(ctx context.Context, w io.Writer, name string, data map[string]any) error</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>ctx, cancel := context.WithTimeout(context.Background(), 2*time.Second)
defer cancel()
err := engine.RenderPageContext(ctx, w, "HomePage", data)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) ServeComponent(name string, data func(*http.Request) map[string]any) http.HandlerFunc</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>mux.HandleFunc("GET /search-results", engine.ServeComponent("SearchResults", func(r *http.Request) map[string]any {
    return map[string]any{"query": r.URL.Query().Get("q")}
}))</code></pre>

    <h3 id="serve-page-component">ServePageComponent</h3>
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) ServePageComponent(name string, data func(*http.Request) (map[string]any, int)) http.HandlerFunc</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>mux.HandleFunc("GET /post/{id}", engine.ServePageComponent("PostPage", func(r *http.Request) (map[string]any, int) {
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) Mount(mux *http.ServeMux, routes map[string]string)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) WithDataMiddleware(fn func(*http.Request, map[string]any) map[string]any) *Engine</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) Register(name, path string) error</code></pre>
    ...
    <h3 id="has">Has</h3>
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) Has(name string) bool</code></pre>
    <p>Reports whether <code>name</code> is a registered component.</p>

    <h3 id="components">Components</h3>
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) Components() []string</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) ValidateAll() []ValidationError</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) RegisterFunc(name string, fn func(...any) (any, error)) *Engine</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) RegisterDirective(name string, dir Directive)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>engine.RegisterDirective("tooltip", &amp;TooltipDirective{})</code></pre>

    <h3 id="missing-prop">WithMissingPropHandler</h3>
    <pre v-syntax-highlight="'go'"><code>func (e *Engine) WithMissingPropHandler(fn MissingPropFunc) *Engine</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>// Abort rendering on any missing prop
...
engine.WithMissingPropHandler(htmlc.SubstituteMissingProp)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func ParseFile(path, src string) (*Component, error)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>type Component struct {
    ...
    <pre v-syntax-highlight="'go'"><code>func (c *Component) Props() []PropInfo</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>type PropInfo struct {
    Name        string   // identifier name
    Expressions []string // template expressions in which it appears
}</code></pre>

    <h3 id="registry">Registry</h3>
    <pre v-syntax-highlight="'go'"><code>type Registry map[string]*Component</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func NewRenderer(c *Component) *Renderer</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (r *Renderer) Render(w io.Writer, scope map[string]any) error
func (r *Renderer) RenderString(scope map[string]any) (string, error)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func Render(w io.Writer, c *Component, scope map[string]any) error
func RenderString(c *Component, scope map[string]any) (string, error)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>type Directive interface {
    ...
    <pre v-syntax-highlight="'go'"><code>type DirectiveBinding struct {
...
func (d *CalloutDirective) InnerHTML() (string, bool) {
    ...
    <pre v-syntax-highlight="'go'"><code>type StyleCollector struct { /* unexported fields */ }</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>func (sc *StyleCollector) Add(c StyleContribution)
func (sc *StyleCollector) All() []StyleContribution</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>type StyleContribution struct {
    ...
    <pre v-syntax-highlight="'go'"><code>func ScopeID(path string) string
func ScopeCSS(css, scopeAttr string) string</code></pre>
    ...
    <h4>ParseError</h4>
    <pre v-syntax-highlight="'go'"><code>type ParseError struct {
    ...
    <h4>RenderError</h4>
    <pre v-syntax-highlight="'go'"><code>type RenderError struct {
    ...
    <pre v-syntax-highlight="'go'"><code>type ValidationError struct {
    ...
    <pre v-syntax-highlight="'go'"><code>type SourceLocation struct {
    ...
    <pre v-syntax-highlight="'go'"><code>type MissingPropFunc func(name string) (any, error)
...
func SubstituteMissingProp(name string) (any, error)</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>var ErrComponentNotFound = errors.New("htmlc: component not found")
var ErrMissingProp       = errors.New("htmlc: missing required prop")</code></pre>
    ...
    <pre v-syntax-highlight="'go'"><code>if errors.Is(err, htmlc.ErrComponentNotFound) {
    http.NotFound(w, r)
    return
}</code></pre>
